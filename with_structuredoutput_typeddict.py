...
class Review(TypedDict):
    summary : Annotated[str,"A breif summary of the reivew"]
    sentiment: Annotated[str,"Return sentiment of the review either negative, positive or neutral"]
    pros: Annotated[list[str], "Provide a list of all pros mentioned"]
    cons: Annotated[list[str], "Provide a list of all cons mentioned"]
